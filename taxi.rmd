...
# max = max(dataset_test$pickup_time)
# min = min(dataset_test$pickup_time)
# temp = 0
# for (i in 1:length(dataset_test$pickup_time)){
#   temp[i] = (dataset_test$pickup_time[i] - min) / (max - min)
# }
# dataset_test$pickup_time = temp
# 
